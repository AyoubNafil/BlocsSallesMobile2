...
public class SalleBlocRecyclerViewAdapter extends RecyclerView.Adapter<SalleBlocRecyclerViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public SalleBlocRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_salle, parent, false);
        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SalleBlocRecyclerViewAdapter.ViewHolder holder, int position) {
